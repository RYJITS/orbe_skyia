...
const InstallGuideModal: React.FC<InstallGuideModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/95 font-mono">
            <div className="w-full max-w-md bg-black border border-green-900/50 shadow-[0_0_50px_rgba(0,255,0,0.05)] relative overflow-hidden flex flex-col animate-in fade-in zoom-in duration-300">

                {/* Header */}
                <div className="flex justify-between items-center p-4 border-b border-green-900/30 bg-black/50">
                    <h2 className="text-green-500 font-display tracking-widest flex items-center gap-2 text-sm md:text-base">
